...
func main() {
	...
	_, err = dev.WriteString(string(escp2.SetPageFormatA4()))  // Już nie psuje
	if err != nil {
	...
	for i, text := range []string{surname, addr, addline2, string([]byte{commandcodes.CR, commandcodes.LF, commandcodes.FF})} {
